...
async function processBatch4() {
  try {
    console.log('🚀 PROCESSING BATCH 4 (501-600) WITH SMART MATCHING');
    console.log('==================================================\n');

    // Read the Batch 4 CSV file
    const csvPath = '/Users/mac/Downloads/Batch4_Products_501-600_PROFESSIONAL.csv';
    ...
    console.log(`📄 Processing ${lines.length - 1} products from Batch 4\n`);
    ...
    // Print summary
    console.log('\n' + '='.repeat(60));
    console.log('📊 BATCH 4 PROCESSING SUMMARY');
    ...
    if (failedMatches.length > 0) {
      ...
      fs.writeFileSync(
        '/Users/mac/Documents/Zonemation/Transformation digital/Clients/KITMEDAPP/batch4-unmatched.csv',
        header + '\n' + unmatchedContent
      );
      
      console.log('\n📝 Unmatched products saved to: batch4-unmatched.csv');
    }
