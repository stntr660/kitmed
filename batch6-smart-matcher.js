...
async function processBatch6() {
  try {
    console.log('🚀 PROCESSING BATCH 6 (701-800) WITH SMART MATCHING');
    console.log('==================================================\n');

    // Read the Batch 6 CSV file
    const csvPath = '/Users/mac/Downloads/Batch6_Products_701-800_PROFESSIONAL.csv';
    ...
    console.log(`📄 Processing ${lines.length - 1} products from Batch 6\n`);
    ...
    // Print summary
    console.log('\n' + '='.repeat(60));
    console.log('📊 BATCH 6 PROCESSING SUMMARY');
    ...
    if (failedMatches.length > 0) {
      ...
      fs.writeFileSync(
        '/Users/mac/Documents/Zonemation/Transformation digital/Clients/KITMEDAPP/batch6-unmatched.csv',
        header + '\n' + unmatchedContent
      );
      
      console.log('\n📝 Unmatched products saved to: batch6-unmatched.csv');
    }
