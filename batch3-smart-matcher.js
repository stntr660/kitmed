...
function extractKeyTerms(name) {
  const medicalTerms = [
    ...
    'hydrophilic', 'acrylic', 'silicone', 'pmma'
  ];
...
async function processBatch3() {
  try {
    console.log('🚀 PROCESSING BATCH 3 (401-500) WITH SMART MATCHING');
    console.log('==================================================\n');

    // Read the Batch 3 CSV file
    const csvPath = '/Users/mac/Downloads/Batch3_Products_401-500_PROFESSIONAL.csv';
    ...
    console.log(`📄 Processing ${lines.length - 1} products from Batch 3\n`);
    ...
    if (failedMatches.length > 0) {
      ...
      fs.writeFileSync(
        '/Users/mac/Documents/Zonemation/Transformation digital/Clients/KITMEDAPP/batch3-unmatched.csv',
        header + '\n' + unmatchedContent
      );
      
      console.log('\n📝 Unmatched products saved to: batch3-unmatched.csv');
    }
